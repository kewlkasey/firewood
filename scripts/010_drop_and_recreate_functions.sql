-- Drop existing functions and recreate them with correct signatures

-- Drop existing functions first
DROP FUNCTION IF EXISTS check_auth_users();
DROP FUNCTION IF EXISTS create_profile_simple(UUID, TEXT, TEXT, TEXT);
...
-- Recreate check_auth_users function with correct return type
...
-- Create the direct profile creation function
